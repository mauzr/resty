...
func (o *output) Open() io.Action {
	return o.setup
}

func (o *output) Close() io.Action {
	return func() error {
		if o.file == nil {
			return nil
		}
...
func (o *output) Set(value bool) io.Action {
	...
	return func() error {
		...
		return o.file.Ioctl(ioctl, uintptr(unsafe.Pointer(&payload[0])))()
	}
}
...
func (c *chip) NewOutput(number uint32, active bool, value bool) Output {
	...
	o := output{}
	o.setup = func() error {
		if err := c.file.Ioctl(ioctl, uintptr(unsafe.Pointer(&r)))(); err != nil {
			return err
		}
